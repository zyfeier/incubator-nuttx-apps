/****************************************************************************
 * apps/graphics/lvgl/lv_porting/lv_ffmpeg_interface.c
 *
...
static lv_res_t decoder_info(lv_img_decoder_t *decoder,
                             const void *src,
                             lv_img_header_t *header)
{
  /* Get the source type */
 ...
 *
 * Description:
 *   Open a image and return the decided image.
 *
 * Input Parameters:
 *   decoder - pointer to a decoder
 ...
 *
 * Returned Value:
 *   LV_RES_OK: no error; LV_RES_INV: can't open.
 *
 ****************************************************************************/
...
/****************************************************************************
 * Name: convert_color_depth
 *
 * Description:
 *   If the display is not in 32 bit format
 *   then covert the image to the current color depth.
 *
 * Input Parameters:
 *   img    - the BGRA8888 image
 *   px_cnt - number of pixels in `img`
 *
 ****************************************************************************/
...
/****************************************************************************
 * Name: ffmpeg_get_img_data
 *
 * Description:
 *   Get the picture buffer address.
 *
 * Input Parameters:
 *   ffmpeg_ctx - pointer to a ffmpeg_ctx
 *
 * Returned Value:
 *   picture buffer address.
 *
 ****************************************************************************/
...
/****************************************************************************
 * Name: ffmpeg_pix_fmt_is_yuv
 *
 * Description:
 *   Determine whether this pixel format is yuv.
 *
 * Input Parameters:
 *   pix_fmt - see AVPixelFormat
 *
 * Returned Value:
 *   true: this pixel format is yuv.
 *
 ****************************************************************************/
...
/****************************************************************************
 * Name: ffmpeg_output_video_frame
 *
 * Description:
 *   Get the picture buffer address.
 *
...
/****************************************************************************
 * Name: ffmpeg_decode_packet
 *
 * Description:
 *   Decode packet.
 *
 * Input Parameters:
 *   dec        - pointer to an AVCodecContext
 *   pkt        - pointer to an AVPacket
 *   ffmpeg_ctx - pointer to a ffmpeg_ctx
 *
 * Returned Value:
 *   ERROR: <0, OK: =0.
...
/****************************************************************************
 * Name: ffmpeg_open_codec_context
 *
 * Description:
 *   Open codec context.
 *
 * Input Parameters:
 *   stream_idx - pointer to a stream index
 *   dec_ctx    - pointer to an AVCodecContext pointer
 *   dec_ctx    - pointer to a AVFormatContext
 *   type       - AVMediaType
 *
 * Returned Value:
 *   ERROR: <0, OK: =0.
...
/****************************************************************************
 * Name: ffmpeg_get_frame_interval_time
 *
 * Description:
 *   Get video frame interval time.
 *
 * Input Parameters:
 *   ffmpeg_ctx pointer to a ffmpeg_ctx.
 *
 * Returned Value:
 *   frame interval time[ms], ERROR: <0.
 *
 ****************************************************************************/
...
/****************************************************************************
 * Name: ffmpeg_update_next_frame
 *
 * Description:
 *   Update the next frame of the video.
 *
 * Input Parameters:
 *   ffmpeg_ctx pointer to a ffmpeg_ctx.
 *
...
/****************************************************************************
 * Name: ffmpeg_close_src_ctx
 *
 * Description:
 *   Close the src context.
 *
 * Input Parameters:
 *   ffmpeg_ctx - pointer to a ffmpeg_ctx.
 *
...
/****************************************************************************
 * Name: ffmpeg_close_dst_ctx
 *
 * Description:
 *   Close the dst context.
 *
 * Input Parameters:
 *   ffmpeg_ctx - pointer to a ffmpeg_ctx.
 *
