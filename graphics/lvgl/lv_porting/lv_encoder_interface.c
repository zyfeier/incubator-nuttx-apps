/****************************************************************************
 * apps/graphics/lvgl/lv_porting/lv_encoder_interface.c
 *
...
#include "lv_encoder_interface.h"
...
{
  struct encoder_obj_s *encoder_obj = drv->user_data;
...
static lv_indev_t *encoder_init(int fd)
{
  struct encoder_obj_s *encoder_obj = malloc(sizeof(struct encoder_obj_s));
